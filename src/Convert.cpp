...
void Convert::binaryToBase16(
	const unsigned char *pucSrcBinaryData, unsigned long ulSrcBinaryDataSize, char *pDestBase16Data, unsigned long ulDestBase16DataSize
)
...
void Convert::base16ToBinary(
	const char *pSrcBase16Data, unsigned long ulSrcBase16DataSize, unsigned char *pucDestBinaryData, unsigned long ulDestBinaryDataSize
)

{
	...
	for (ulSrcIndex = 0; ulSrcIndex < ulSrcBase16DataSize - 1; ulSrcIndex += 2)
	{
		...
		pucDestBinaryData[ulDestIndex] = (unsigned char)strtol(pBuffer, (char **)NULL, 16);
		ulDestIndex += 1;
	}
}

void Convert::stringToBase16(const char *pSrcStringData, char *pDestBase16Data, unsigned long ulDestBase16DataSize)
...
void Convert::base16ToString(const char *pSrcBase16Data, char *pDestStringData, unsigned long ulDestStringDataSize)

{
	...
	for (ulSrcIndex = 0; ulSrcIndex < ulSrcBase16DataSize - 1; ulSrcIndex += 2)
	{
		...
		pDestStringData[ulDestIndex] = (unsigned char)strtol(pBuffer, (char **)NULL, 16);
		ulDestIndex += 1;
	}
}
